...
void createEntitiesFromMolFile(Entities &entities, MolFile &data,
                               Camera &camera);
...
struct PdbStrand {
    int strand_id;
    int sense;    // @todo enum, 0 -> first, 1 -> parallel, -1 -> anti-parallel
...
// A contiguous sequence of residues (in secondary structures) which form one
// mesh
struct PdbChain {
    char chain_id;
...
struct PdbModel {
    ...
    std::unordered_map<long, PdbConnection>
        connections;                           // hash(serial1, serial2) -> bond
...
struct PdbDictionary {
    // This is a map between residue names and the residue"s connections,
    // (stored as map between atom_name_1+2) -> connection We need to use names
    // since the dictionary doesn"t have a concept of atom id
    std::unordered_map<std::string,
                       std::unordered_map<std::string, PdbDictionaryConnect>>
        residues;
};
...
void updateEntityColorsFromPdbModel(Entities &entities, PdbModel &model,
                                    PdbDrawSettings &settings);
void createPdbModelMeshes(PdbModel &model);
void createEntitiesFromPdbModel(Entities &entities, PdbModel &model,
                                PdbDrawSettings &settings, Camera &camera);

// --------------------------------Color LUTs-------------------------------- //
// Based on: https://jmol.sourceforge.net/jscolors/

const std::unordered_map<std::string, glm::vec3> symbol_to_color_lut = {
    {"", glm::vec3(255, 255, 255)}, {"H", glm::vec3(55, 255, 255)}, {"HE", glm::vec3(217, 255, 255)}, {"LI", glm::vec3(204, 128, 255)}, {"BE", glm::vec3(194, 255, 0)}, {"B", glm::vec3(55, 181, 181)}, {"C", glm::vec3(100, 100, 100)}, {"N", glm::vec3(8, 80, 248)}, {"O", glm::vec3(55, 13, 13)}, {"F", glm::vec3(44, 224, 80)}, {"NE", glm::vec3(179, 227, 245)}, {"NA", glm::vec3(171, 92, 242)}, {"MG", glm::vec3(138, 255, 0)}, {"AL", glm::vec3(191, 166, 166)}, {"SI", glm::vec3(240, 200, 160)}, {"P", glm::vec3(55, 128, 0)}, {"S", glm::vec3(55, 255, 48)}, {"CL", glm::vec3(31, 240, 31)}, {"AR", glm::vec3(128, 209, 227)}, {"K", glm::vec3(43, 64, 212)}, {"CA", glm::vec3(61, 255, 0)}, {"SC", glm::vec3(230, 230, 230)}, {"TI", glm::vec3(191, 194, 199)}, {"V", glm::vec3(66, 166, 171)}, {"CR", glm::vec3(138, 153, 199)}, {"MN", glm::vec3(156, 122, 199)}, {"FE", glm::vec3(224, 102, 51)}, {"CO", glm::vec3(240, 144, 160)}, {"NI", glm::vec3(80, 208, 80)}, {"CU", glm::vec3(200, 128, 51)}, {"ZN", glm::vec3(125, 128, 176)}, {"GA", glm::vec3(194, 143, 143)}, {"GE", glm::vec3(102, 143, 143)}, {"AS", glm::vec3(189, 128, 227)}, {"SE", glm::vec3(255, 161, 0)}, {"BR", glm::vec3(166, 41, 41)}, {"KR", glm::vec3(92, 184, 209)}, {"RB", glm::vec3(112, 46, 176)}, {"SR", glm::vec3(0, 255, 0)}, {"Y", glm::vec3(48, 255, 255)}, {"ZR", glm::vec3(148, 224, 224)}, {"NB", glm::vec3(115, 194, 201)}, {"MO", glm::vec3(84, 181, 181)}, {"TC", glm::vec3(59, 158, 158)}, {"RU", glm::vec3(36, 143, 143)}, {"RH", glm::vec3(10, 125, 140)}, {"PD", glm::vec3(0, 105, 133)}, {"AG", glm::vec3(192, 192, 192)}, {"CD", glm::vec3(255, 217, 143)}, {"IN", glm::vec3(166, 117, 115)}, {"SN", glm::vec3(102, 128, 128)}, {"SB", glm::vec3(158, 99, 181)}, {"TE", glm::vec3(212, 122, 0)}, {"I", glm::vec3(48, 0, 148)}, {"XE", glm::vec3(66, 158, 176)}, {"CS", glm::vec3(87, 23, 143)}, {"BA", glm::vec3(0, 201, 0)}, {"LA", glm::vec3(112, 212, 255)}, {"CE", glm::vec3(255, 255, 199)}, {"PR", glm::vec3(217, 255, 199)}, {"ND", glm::vec3(199, 255, 199)}, {"PM", glm::vec3(163, 255, 199)}, {"SM", glm::vec3(143, 255, 199)}, {"EU", glm::vec3(97, 255, 199)}, {"GD", glm::vec3(69, 255, 199)}, {"TB", glm::vec3(48, 255, 199)}, {"DY", glm::vec3(31, 255, 199)}, {"HO", glm::vec3(0, 255, 156)}, {"ER", glm::vec3(0, 230, 117)}, {"TM", glm::vec3(0, 212, 82)}, {"YB", glm::vec3(0, 191, 56)}, {"LU", glm::vec3(0, 171, 36)}, {"HF", glm::vec3(77, 194, 255)}, {"TA", glm::vec3(77, 166, 255)}, {"W", glm::vec3(3, 148, 214)}, {"RE", glm::vec3(38, 125, 171)}, {"OS", glm::vec3(38, 102, 150)}, {"IR", glm::vec3(23, 84, 135)}, {"PT", glm::vec3(208, 208, 224)}, {"AU", glm::vec3(255, 209, 35)}, {"HG", glm::vec3(184, 184, 208)}, {"TL", glm::vec3(166, 84, 77)}, {"PB", glm::vec3(87, 89, 97)}, {"BI", glm::vec3(158, 79, 181)}, {"PO", glm::vec3(171, 92, 0)}, {"AT", glm::vec3(117, 79, 69)}, {"RN", glm::vec3(66, 130, 150)}, {"FR", glm::vec3(66, 0, 102)}, {"RA", glm::vec3(0, 125, 0)}, {"AC", glm::vec3(112, 171, 250)}, {"TH", glm::vec3(0, 186, 255)}, {"PA", glm::vec3(0, 161, 255)}, {"U", glm::vec3(0, 143, 255)}, {"NP", glm::vec3(0, 128, 255)}, {"PU", glm::vec3(0, 107, 255)}, {"AM", glm::vec3(84, 92, 242)}, {"CM", glm::vec3(120, 92, 227)}, {"BK", glm::vec3(138, 79, 227)}, {"CF", glm::vec3(161, 54, 212)}, {"ES", glm::vec3(179, 31, 212)}, {"FM", glm::vec3(179, 31, 186)}, {"MD", glm::vec3(179, 13, 166)}};

const glm::vec3 unknown_residue_color =
    glm::vec3(190 / 255.f, 160 / 255.f, 110 / 255.f);
